...
GraveFallGame.scene.Menu.prototype.init = function () {
    ...
    panel = this.createMenuPanel(250, 80, 780, 434, this.menuSkin, framePaletteSwaps);
    this.stage.addChild(panel);
    this.panel = panel;

    title = this.createText("GRAVEFALL", 0, 134, 4.1, 540);
    this.centerText(title, screen.centerX, 4.1);
    this.stage.addChild(title);
    this.title = title;

    titleAccent = new rune.display.Graphic(430, 186, 420, 4);
